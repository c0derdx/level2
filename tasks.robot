...
***** Keywords ***
Open robot website and download order file
...
*** Keywords ***
Input from User
    ${takeInput}=   Get Value From User     Type yes to start the process.
    [Return]   ${takeInput}
